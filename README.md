...
This repository contains the resources and code associated with my research paper: 
Enhancing Theoretical Efficiency of Solar Cells: From Single-Junction Fundamentals
to Down-Conversion Integrated Multijunction Architectures and Future Prospects for
Up-Conversion

Link to paper: https://doi.org/10.58445/rars.3266
...
- The Down-Converting Multijunction Cell Optimizer, used to determine optimal bandgaps for DC layers and MJ junctions
- The Modeling and Visualization Code, for generating figures directly from input data or optimizer outputs
- The UC–DC–MJ Optimizer, used to identify optimal up- and down-conversion layers for hybrid MJ architectures
